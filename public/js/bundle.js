...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm9yeWFuYS1kaW5rb3ZhIiwiYSI6ImNrY2dxc21vZzBkZ2Yyc3FreXc3N2g4eXQifQ._OpD7sOs-mak6D1LbS4XSA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your review has been added');
              window.setTimeout(function () {
...
},{"axios":"../../../../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"stripePayments.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51H739AE5ixecAG7LmKUGy3X5xogylfgAXMlb45kGAzjkY0U8VlvHI6cprceTvjwPmgSWUfoHTkdiseyjoD5uK2QS00XDQyJEMZ');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var confirmPassword = document.getElementById('confitmPassword').value;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  (0, _stripePayments.bookTour)(tourId);
});
var ratingStars = document.querySelectorAll('.rating-star-container');
var rating = 0;
var activeStars = [];
ratingStars.forEach(function (el) {
  activeStars.push(el.firstChild);
  el.addEventListener('click', function (e) {
    rating = e.target.dataset.ratingStars;
    activeStars.forEach(function (el) {
